		...
		<div class="bg-transparent">
			...
			id="message-input-container"
						class="flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border {$temporaryChatEnabled
								? 'border-dashed border-gray-200 dark:border-gray-700 hover:border-gray-300 focus-within:border-primary-300 hover:dark:border-gray-600 focus-within:dark:border-primary-500/50'
								: ' border-gray-200/60 dark:border-gray-700/40 hover:border-gray-300 focus-within:border-primary-300 hover:dark:border-gray-600 focus-within:dark:border-primary-500/50'}  transition-all duration-200 px-1 bg-white dark:bg-gray-800/50 backdrop-blur-sm dark:text-gray-100"
										...
										{#if prompt === '' && files.length === 0 && ($_user?.role === 'admin' || ($_user?.permissions?.chat?.call ?? true))}
											<div class=" flex items-center">
												...
												<Tooltip content={$i18n.t('Voice mode')}>
													<button
						class=" bg-primary-500 text-white hover:bg-primary-600 dark:bg-primary-500 dark:text-white dark:hover:bg-primary-400 transition shadow-sm rounded-full p-1.5 self-center"
													type="button"
													on:click={async () => {
												...
												<Tooltip content={$i18n.t('Send message')}>
													<button
														...
														class="{!(prompt === '' && files.length === 0)
															? 'bg-primary-500 text-white hover:bg-primary-600 dark:bg-primary-500 dark:text-white dark:hover:bg-primary-400 shadow-sm '
