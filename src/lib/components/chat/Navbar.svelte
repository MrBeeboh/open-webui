...
>
	<div class="flex items-center w-full pl-1.5 pr-1">
		<div
			...
			class="{chat?.id
				? 'visible'
				: 'invisible'} bg-linear-to-b via-40% to-97% from-gray-50/95 via-gray-50/60 to-transparent dark:from-gray-900/95 dark:via-gray-900/60 dark:to-transparent pointer-events-none absolute inset-0 -bottom-10 z-[-1]"
		></div>
